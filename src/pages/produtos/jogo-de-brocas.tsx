...
export default function Produtos({ data }: any) {
    ...
    const jogoDeBrocas = tools.filter((tool: any) => tool.categories.includes(47))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Jogo de Brocas</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {jogoDeBrocas.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=47&orderby=title&order=asc',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
