...
export default function Produtos({ data }: any) {
    ...
    const escariadores = tools.filter((tool: any) => tool.categories.includes(49))
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=49&orderby=title&order=asc',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
