...
export default function Produtos({ data }: any) {
    ...
    const brocasDeHSS = tools.filter((tool: any) => tool.categories.includes(45))
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <div className={styles.pageIndication}>
                                ...
                                <a href="#">Brocas de HSS</a>
                            </div>
                        </div>

                        <div className="col-12">
                            <div className={styles.products}>
                                {brocasDeHSS.map(tool =>(
...
export const getStaticProps: GetStaticProps = async () => {
    const { data } = await api.get('tools?per_page=100&_embed&categories=45&orderby=title&order=asc',  {
        params: {
            _limit: 12,
            _order: 'desc'
        }
